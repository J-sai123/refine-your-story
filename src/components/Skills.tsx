...
const ProjectSection = () => {
  const skills = [
    ...
    { name: "GitHub", level: "Beginner", category: "Tools" },
    { name: "VS Code", level: "Internediate", category: "Tools" },
    ...
    { name: "Object Oriented Programming", level: "Intermediate", category: "Computer Science" },
